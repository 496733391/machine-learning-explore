...
# author_list1 = pd.read_excel('C:/Users/Administrator/Desktop/test_data/test_data.xlsx', sheet_name='Sheet1')
# author_list2 = pd.read_excel('C:/Users/Administrator/Desktop/test_data/test_data.xlsx', sheet_name='Sheet2')
#
# author_list = pd.merge(author_list2, author_list1, how='left', left_on='person_id', right_on='学者代码')
